...
class PartitioningStrategy:
    ...
    # Standard partition paths for bronze/silver/gold
    BRONZE_PARTITION_TEMPLATE = "s3://lakehouse/{environment}/{dataset}/year={year}/month={month}/day={day}/"
    SILVER_PARTITION_TEMPLATE = "s3://lakehouse/{environment}/silver/{dataset}/year={year}/month={month}/day={day}/"
    GOLD_PARTITION_TEMPLATE = "s3://lakehouse/{environment}/gold/{aggregation_level}/{dataset}/year={year}/month={month}/day={day}/"
