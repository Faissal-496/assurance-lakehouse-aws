...
def main():
    ...
    # Récupération dynamique du bucket S3 depuis .env
    ...
    output_contrat2 = resolver.s3_layer_path("bronze", "Contrat2", bucket=s3_bucket)
    ...
    output_client = resolver.s3_layer_path("bronze", "Client", bucket=s3_bucket)
